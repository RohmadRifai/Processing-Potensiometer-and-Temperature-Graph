...
void draw ()
{
  ...
  if (inString != null) {
    ...
    line(40,height-196,width,height-196);
     
    stroke(100,100,255);                          // 60 degree line
    line(40,height-350,width,height-350);
    
    stroke(100,100,255);                          // 90 degree line
    line(40,height-504,width,height-504);
